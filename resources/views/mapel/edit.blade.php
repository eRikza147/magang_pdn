...
@section('content')
    <form action="{{ route('updatemapel', $mapel->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="flex flex-col gap-2">
            ...
            <input type="text" name="nmapel" class="p-2 border rounded-md" value="{{ $mapel->nmapel}}">
        </div>
        <div class="flex flex-col gap-2">
            <label for="">Guru</label>
            <input type="text" name="guru" class="p-2 border rounded-md" value="{{ $mapel->guru}}">
        </div>
        <div class="flex flex-col gap-2">
            <label for="">Jadwal</label>
            <input type="text" name="jadwal" class="p-2 border rounded-md" value="{{ $mapel->jadwal}}">
        </div>
        <div class="flex flex-col gap-2">
